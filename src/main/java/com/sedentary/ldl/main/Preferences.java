...
public class Preferences {
    ...
    public static final String ORIGIN_FILE_DIALOG_LOCATION = "__originfiledialoglocation__";
    public static final String PICTURES_FOLDER_DIALOG_LOCATION = "__picturesfolderdialoglocation__";
    public static final String OUTPUT_FOLDER_DIALOG_LOCATION = "__outputfolderdialoglocation__";
    public static final String OUTPUT_FILE = "__outputfile__";
